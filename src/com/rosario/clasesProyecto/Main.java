...
public class Main {
   ...
   public static void elecccion(){
       ...
       System.out.println("Eliga una opcion \n 1: administrador o 2: cliente");
        int num;
        num=scanner.nextInt();
       switch(num){
           case 1: ingresarAdministrador();
           break;
           case 2: elecccion2();
           break;
           default:
    ...
    public static void elecccion2() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Eliga una opcion \n 1: Pedir pizza o 2: Hacer reservacion");
        int num;
        num = scanner.nextInt();
        switch (num) {
            case 1: pedirPizza();
    ...
    public static void ingresarAdministrador(){
        ...
        administrador.setContrasenia("suyElmasChingonAqui457");
